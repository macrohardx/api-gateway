...
module.exports = (req, res, next) => {
    ...
    jwt.verify(token, config.secret, async (err, decoded) => {
        ...
        req.user = user
        req.headers['x-user-id'] = req.userId = decoded.id
        req.headers['x-username'] = req.username = decoded.username
        req.headers['x-session-id'] = req.sessionId = decoded.sessionId
